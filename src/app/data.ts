...
export const translations: Record<"en" | "vi", TranslationDictionary> = {
  ...
  vi: {
    ...
    aboutText: "Tôi là một Web Developer nhạy bén, tập trung vào tối ưu hiệu năng hệ thống với hơn 3 năm kinh nghiệm thực chiến trong việc phát triển kiến trúc phân tán (microservices), xử lý truyền tải video thời gian thực và quản trị cơ sở dữ liệu lớn. Tôi vận dụng linh hoạt Next.js, gRPC, Node.js và MongoDB để giải quyết triệt để các điểm nghẽn hiệu suất phức tạp—bao gồm tối ưu hóa truy vấn trên các bộ dữ liệu khổng lồ chứa hàng trăm triệu bản ghi.",
    eduTitle: "Học Vấn",
